...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240514082016_Initial-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DriveTrain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.GearBoxType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ProducingCountry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.TechnicalCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Car", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.DriveTrain", "DriveTrain")
                        .WithMany("Cars")
                    ...
                    b.HasOne("Domain.Entities.GearBoxType", "GearBoxType")
                        .WithMany("Cars")
                    ...
                    b.HasOne("Domain.Entities.TechnicalCondition", "TechnicalCondition")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("Domain.Entities.Make", b =>
                {
                    b.HasOne("Domain.Entities.ProducingCountry", "ProducingCountry")
                        .WithMany("Makes")
